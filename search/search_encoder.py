...
def search_encoder_params():
    ...
    param_grid = {
        ...
        'feature_fusion': ['encoder']  # 固定使用encoder融合方式
    }
        ...
        for dropout in param_grid['dropout']:
            for lr in param_grid['learning_rate']:
                ...
                print(f"参数: text_dim={text_dim}, "
                     f"dropout={dropout}, lr={lr}, fusion=encoder")
                
                # 根据参数生成实验名称
                exp_name = f"encoder_textdim{text_dim}_dropout{dropout}_lr{lr}"
                ...
                # 创建日志目录
                log_dir = os.path.join(script_dir, "../logs/encoder_search_logs")
